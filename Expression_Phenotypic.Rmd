...
## check if all TSS on the same strand
## double check on the 5' most for paper 


## pwd interval of what, right now are we caculating the PWD over the pELS interval or dELS

## difference between means and variance between the normal and variances, three different normal (normal colon, normal from the mmrD and normal from mmrP)

## 100 gene between scTransform vs log1p, will we pick out differnent gene, how many of them are overlap